ace.define("ace/theme/gruvbox-css",["require","exports","module"],function(n,e,c){c.exports=`.ace-gruvbox .ace_gutter-active-line {
...
`}),ace.define("ace/theme/gruvbox",["require","exports","module","ace/theme/gruvbox-css","ace/lib/dom"],function(n,e,c){e.isDark=!0,e.cssClass="ace-gruvbox",e.cssText=n("./gruvbox-css");var a=n("../lib/dom");a.importCssString(e.cssText,e.cssClass,!1)}),function(){ace.require(["ace/theme/gruvbox"],function(n){typeof module=="object"&&typeof exports=="object"&&module&&(module.exports=n)})}();
