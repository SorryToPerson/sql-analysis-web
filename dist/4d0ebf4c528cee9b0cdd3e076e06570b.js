ace.define("ace/snippets/gobstones.snippets",["require","exports","module"],function(_,n,T){T.exports=`# scope: gobstones
...
snippet docs (funci\xF3n con par\xE1metros)
	/*
		...
		@TIPO: \${6:...}
	*/
`}),ace.define("ace/snippets/gobstones",["require","exports","module","ace/snippets/gobstones.snippets"],function(_,n,T){"use strict";n.snippetText=_("./gobstones.snippets"),n.scope="gobstones"}),function(){ace.require(["ace/snippets/gobstones"],function(_){typeof module=="object"&&typeof exports=="object"&&module&&(module.exports=_)})}();
